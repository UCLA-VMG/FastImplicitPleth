...
class PlethTemporalModel(torch.nn.Module):
...
def main(args):
    ...
    # Model 2: Capture PPG
    pleth_model = PlethTemporalModel(tcnn.NetworkWithInputEncoding(args.pleth_encoding["input_dims"],
    ...
    #       The Appearance model would need to be altered to separate the network and encoding models.
