...
for folder in list_of_folders:
    ...
    # Start frame 0
    config = os.path.join(args.config_folder, f'residual_0.json')
    ...
    # Start frame 300
    config = os.path.join(args.config_folder, f'residual_300.json')
    if os.path.exists(config):
    ...
    # Start frame 600
    config = os.path.join(args.config_folder, f'residual_600.json')
    if os.path.exists(config):
