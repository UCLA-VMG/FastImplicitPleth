...
for folder in list_of_folders:
    ...
    os.system(f'CUDA_VISIBLE_DEVICES={args.cuda_dev} nohup python -m {filename} -vp {vp} -config {config} --append_save_path _{folder}  --append_load_path _{folder}/latest.pth --verbose > {log} ')
